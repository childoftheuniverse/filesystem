...
/*
Error returned when an operation is called on a file system which does not
have the requested functionality.
*/
var EUNSUPP error = errors.New("File system does not support this operation")

/*
Error which should only ever be returned directly from this framework
indicating that no file system is registered under that name.
*/
var ENOFS error = errors.New("No file system loaded for URL type")

/*
File watchers will be called when a watched file is modified. The first
parameter will be the path of the file being changed, and the second parameter
is a ReadCloser which can be used to access the modified contents.
...
/*
Function to call to stop watching a file.
*/
...
/*
Fetch a pointer to the entire implementation of the file system which would
be used to handle the URL. If no file system can handle the URL, this returns
nil.
